...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col px-3 py-4 md:px-2">
      <div className="flex flex-col gap-2 h-20 p-6 rounded-lg items-center justify-center border md:h-40 scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl">
        Newsman
